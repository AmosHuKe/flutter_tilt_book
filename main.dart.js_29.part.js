...
$__dart_deferred_initializers__.current=function(a,b,c,$){var A,B,H,F,I,E,D={I0:function I0(){},
aF_(){return new D.oR(null)},
oR:function oR(d){this.a=d}},C,K,G,L
A=c[0]
B=c[2]
H=c[41]
F=c[34]
...
x(D.I0,A.dA)
x(D.oR,A.W)})()
A.cD(b.typeUniverse,JSON.parse('{"I0":{"dA":[]},"oR":{"W":[],"c":[]}}'))
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_29",e:"endPart",h:b})})($__dart_deferred_initializers__,"7zg2dFFOens9D5VdxQF+yLjY1xg=");