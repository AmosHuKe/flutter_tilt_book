...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1614: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ...
      _1621: (x0,x1) => x0.add(x1),
      _1622: (x0,x1) => x0.append(x1),
      _1623: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1624: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1624(f,arguments.length,x0) }),
      _1625: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1632: x0 => ({frequency: x0}),
      _1633: x0 => new Accelerometer(x0),
      _1634: x0 => x0.start(),
      ...
      _1661: x0 => x0.length,
      _1663: (x0,x1) => x0[x1],
      _1664: (x0,x1,x2) => x0[x1] = x2,
      _1667: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1669: x0 => new Int8Array(x0),
      _1670: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1671: x0 => new Uint8Array(x0),
      _1679: x0 => new Int32Array(x0),
      _1683: x0 => new Float32Array(x0),
      _1685: x0 => new Float64Array(x0),
      _1718: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1719: () => new TextDecoder("utf-8", {fatal: true}),
      _1720: () => new TextDecoder("utf-8", {fatal: false}),
      _1721: x0 => new WeakRef(x0),
      _1722: x0 => x0.deref(),
      _1728: Date.now,
      _1730: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1731: s => {
      ...
      _1733: () => typeof dartUseDateNowForTicks !== "undefined",
      _1734: () => 1000 * performance.now(),
      _1735: () => Date.now(),
      _1736: () => {
      ...
      _1738: () => new WeakMap(),
      _1739: (map, o) => map.get(o),
      _1740: (map, o, v) => map.set(o, v),
      _1741: () => globalThis.WeakRef,
      _1751: s => JSON.stringify(s),
      _1752: s => printToConsole(s),
      _1753: a => a.join(''),
      _1756: (s, t) => s.split(t),
      _1757: s => s.toLowerCase(),
      _1758: s => s.toUpperCase(),
      _1759: s => s.trim(),
      _1760: s => s.trimLeft(),
      _1761: s => s.trimRight(),
      ...
      _1766: Object.is,
      _1767: s => s.toUpperCase(),
      _1768: s => s.toLowerCase(),
      _1769: (a, i) => a.push(i),
      _1773: a => a.pop(),
      ...
      _1782: (a, i) => a[i],
      _1783: (a, i, v) => a[i] = v,
      _1785: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1786: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1787: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1788: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1789: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1790: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1791: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1792: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1794: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1795: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1796: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1797: (t, s) => t.set(s),
      _1799: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1801: o => o.buffer,
      _1802: o => o.byteOffset,
      _1803: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1804: (b, o) => new DataView(b, o),
      _1805: (b, o, l) => new DataView(b, o, l),
      _1806: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1807: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1808: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1809: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1810: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1811: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1812: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1813: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1814: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1815: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1816: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1817: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1820: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1821: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1822: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1823: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1824: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1825: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1838: (o, t) => o instanceof t,
      ...
      _1884: x0 => x0.pop(),
      _1886: o => o === undefined,
      _1905: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1907: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1908: o => o instanceof RegExp,
      _1909: (l, r) => l === r,
      _1910: o => o,
      _1911: o => o,
      _1912: o => o,
      ...
      _1919: l => arrayFromDartList(Int8Array, l),
      _1920: l => arrayFromDartList(Uint8Array, l),
      _1921: l => arrayFromDartList(Uint8ClampedArray, l),
      _1922: l => arrayFromDartList(Int16Array, l),
      _1923: l => arrayFromDartList(Uint16Array, l),
      _1924: l => arrayFromDartList(Int32Array, l),
      _1925: l => arrayFromDartList(Uint32Array, l),
      _1926: l => arrayFromDartList(Float32Array, l),
      _1927: l => arrayFromDartList(Float64Array, l),
      _1928: x0 => new ArrayBuffer(x0),
      _1929: (data, length) => {
      ...
      _1960: x0 => x0.index,
      _1966: x0 => x0.flags,
      _1967: x0 => x0.multiline,
      _1968: x0 => x0.ignoreCase,
      _1969: x0 => x0.unicode,
      _1970: x0 => x0.dotAll,
      _1971: (x0,x1) => x0.lastIndex = x1,
      _1976: v => v.toString(),
      _1977: (d, digits) => d.toFixed(digits),
      _1981: x0 => x0.random(),
      _1982: x0 => x0.random(),
      _1986: () => globalThis.Math,
      _3858: () => globalThis.window,
      _3905: x0 => x0.history,
      _3923: x0 => x0.navigator,
      _4314: x0 => x0.userAgent,
      _13616: () => globalThis.document,
      _13617: () => globalThis.window,
      _13622: (x0,x1) => x0.height = x1,
      _13624: (x0,x1) => x0.width = x1,
      _13628: x0 => x0.head,
      _13630: x0 => x0.classList,
      _13635: (x0,x1) => x0.innerText = x1,
      _13636: x0 => x0.style,
      _13637: x0 => x0.sheet,
      _13639: x0 => x0.offsetX,
      _13640: x0 => x0.offsetY,
      _13641: x0 => x0.button,
      _13663: x0 => x0.x,
      _13664: x0 => x0.y,
      _13665: x0 => x0.z,
      ...
      _13670: x0 => x0.y,
      _13671: x0 => x0.z,
      _13672: (x0,x1) => x0.onreading = x1,
      _13673: (x0,x1) => x0.onerror = x1,
      _13687: x0 => x0.error,
      _13688: x0 => x0.name,
      _13689: x0 => x0.message,
