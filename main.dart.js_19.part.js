...
$__dart_deferred_initializers__.current=function(a,b,c,$){var A,B,D={B9:function B9(d,e,f,g){var _=this
_.c=d
_.d=e
_.f=f
_.a=g}},C,E,F
...
l.cR()}k=A.aX(m,m,B.l,B.m,m,this.d,m,m,this.c)
v=A.cW(m,A.aX(m,m,B.l,B.i,m,1,m,m,m),m,m,0,0,m,m)
u=A.cW(0,A.aX(m,m,B.l,B.i,m,m,m,m,1),m,m,m,m,0,m)
t=y.a
s=A.cW(m,new A.br(C.Fh,A.cT(A.b([A.bC("x: "+B.c.a6(j.a,2)+"\xb0",m,m,m,C.hH),A.bC("x areaProgress: "+B.c.a6(x.a,2),m,m,m,C.hH)],t),B.as,B.F,B.A),m),m,m,10,m,m,m)
r=A.cW(m,new A.br(C.Fq,A.cT(A.b([A.bC("y: "+B.c.a6(j.b,2)+"\xb0",m,m,m,C.hH),A.bC("y areaProgress: "+B.c.a6(x.b,2),m,m,m,C.hH)],t),B.as,B.F,B.A),m),m,m,m,m,10,m)
q=w!=null
p=q?w.a-2:m
o=q?w.b-2:m
