---
title: Changelog
description: Changelog and improvements to the Documents project.
keywords: ["documents", "changelog"]
---

<Note title="Important" type="success">
See the [Migration Guide](/en/docs/migration-guides) for the details of breaking
