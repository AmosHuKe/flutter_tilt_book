...
You can compose the [TiltContainer widget][TiltContainer widget list] within the Tilt widget to wrap different effects.  
...
[TiltContainer widget list]: /en/v4-rc/docs/widgets/tilt-container
