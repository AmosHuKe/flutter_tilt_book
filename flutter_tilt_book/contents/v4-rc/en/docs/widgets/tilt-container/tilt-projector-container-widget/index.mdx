...
description: Learn about TiltProjectorContainer parameters. TiltProjectorContainer widget will have tilt and projector-like shadow effects.
keywords: ["widgets", "container", "TiltProjectorContainer widget"]
---
...
/// Tilt.projector is a convenient widget that combines Tilt and TiltProjectorContainer.
Tilt.projector(
  childLayout: childLayout,
  child: SizedBox(width: 150, height: 300),
),
...
[TiltProjectorContainer widget parameters]: #tiltprojectorcontainer-widget-parameters
[ChildLayout]: #childlayout
