...
| perspectiveIntensity    | `double?`              | `null`                         | Perspective intensity (near-large, far-small). <br/> When `null`, it defaults to a size-adaptive value.                                                                                                                                                                                                                                                      |
| zOffset                 | `double`               | `0.0`                          | The offset of the rotation pivot along the Z-axis. <br/> When non-zero, the widget produces a tilting and swinging effect around the offset pivot point on the Z-axis. <br/> e.g. <br/> `-100`: The pivot is 100 pixels behind the widget. <br/> `100`: The pivot is 100 pixels in front of the widget. <br/> `0`: The pivot is at the center of the widget. |
...
[Tilt container widget list]: /en/v4/docs/widgets/tilt-container
