...
description: Learn about TiltBaseContainer widget parameters. TiltBaseContainer widget will have default tilt, shadow, and light effects.
...
| maxIntensity  | `double`         | `0.25`                  | Color maximum opacity for tilt progresses.                                                                                                                                                    |
...
| enableReverse | `bool`           | `false`                 | Reverse light direction. <br/> Affects: <br/> `[ShadowBaseConfig.direction]` (not affected after configuration). <br/> `[ShadowBaseConfig.enableReverse]` (not affected after configuration). |
...
| minIntensity  | `double`           | `0.0`               | Color minimum opacity, also initial opacity.                                                                |
| maxIntensity  | `double`           | `0.25`              | Color maximum opacity as tilt progresses.                                                                   |
