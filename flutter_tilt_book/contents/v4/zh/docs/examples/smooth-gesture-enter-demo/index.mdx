...
description:
keywords: ["示例", "Smooth Gesture Enter"]
---

<ExampleCodeWidget name="SmoothGestureEnterDemo" height={1280} previewText="预览" codeText="代码">
```dart
...
Tilt(
  ...
  tiltConfig: const TiltConfig(
    angle: 20,
    enterDuration: const Duration(milliseconds: 1000),
    moveDuration: const Duration(milliseconds: 100),
    enterToMoveDuration: const Duration(milliseconds: 600),
