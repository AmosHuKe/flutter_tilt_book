...
t===$&&B.a()
t=B.a8C(D.u,H.eU(I.kt("assets/parallax_card/Artwork-MichaHuigen.jpg",D.aT,v,360),D.h2),D.aT,t)
x=w.f
return B.mj(D.bh,B.iA(E.d7(v,u,F.kv,new E.h0(D.ac,B.b([t,B.aqh(0,B.aC5(B.aX(v,C.N9,D.l,v,C.AZ,v,v,v,v),D.bS,x))],y.e),D.ac),K.ee,v,v,G.yg,C.WB,v),D.aZ,v,new A.adm(w),new A.adn(w),v),new A.ado(w),new A.adp(w),v,v,v,new A.adq(w))}}
A.Fi.prototype={
l(){var x=this,w=x.aH$
if(w!=null)w.G(x.gf5())
x.aH$=null
...
C.Ef=new B.d_(0.16,1,0.3,1)
C.El=new B.d_(0.6,0.04,0.98,0.335)
C.F5=new B.aC(24e5)
...
C.A9=new B.e_(D.ia,null,null,C.Wh,null)
C.Is=B.b(x([C.Wo,C.Wi,F.kt,C.A9]),y.e)
C.E9=new B.rf(D.aw,D.tm,D.A,D.as,null,D.bl,null,C.Is,null)
C.N9=new B.br(C.FB,C.E9,null)
C.WB=new E.dX(!1,null,6,null,!0,D.aT,!0,!0,!0,!1,D.bS,D.E)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_11",e:"endPart",h:b})})($__dart_deferred_initializers__,"lQKQ1rKuXTMmX59qEdNaatTsR4M=");