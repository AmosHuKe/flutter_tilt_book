...
class PageLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final showBorderRadius = routeData.queryParams.getBool(
      RouteQueryParams.showBorderRadius.name,
      true,
    );

    final borderRadius = layout.md
...
class _BodyContainerState extends State<BodyContainer> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final layout = Layout(context);
    final routeData = RouteData.of(context);
    final showCode = routeData.queryParams.getBool(RouteQueryParams.showCode.name, true);
    final showBorderRadius = routeData.queryParams.getBool(
      RouteQueryParams.showBorderRadius.name,
      true,
    );
